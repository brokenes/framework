package org.github.framework.common.reflect;


import org.apache.commons.beanutils.ConvertUtils;
import org.github.framework.common.collection.CustomList;
import org.github.framework.common.exception.Ex;
import org.github.framework.common.exception.SystemErrorException;
...
public class ClassWrapper<T> {
    ...
    public static <T> Class<T>[] getTypes(T... objs) {
        List<Class<T>> clsList = CustomList.arrayList();
        for (T o : objs) {
            if (o != null) {
