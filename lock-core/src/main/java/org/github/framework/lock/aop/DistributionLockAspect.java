...
import org.github.framework.lock.constrants.LockConstants;
import org.github.framework.lock.exception.LockException;
import org.github.framework.lock.support.SimpleLockInfo;
...
public class DistributionLockAspect extends ApplicationObjectSupport {
    ...
    @Pointcut("@annotation(org.github.framework.lock.annotation.Locking)")
